...
const DIAGRAMS: Record<string, ReactElement> = {
  ...
  gmma_above: (
    <>
      <L d="M20 96 Q90 84 150 62 T216 34" c={MUTED} w={1} />
      <L d="M20 92 Q90 79 150 57 T216 29" c={MUTED} w={1} />
      <L d="M20 88 Q90 74 150 52 T216 24" c={MUTED} w={1} />
      <L d="M20 84 Q90 69 150 47 T216 19" c={MUTED} w={1} />
      <L d="M24 82 L60 68 L96 58 L132 40 L172 26 L212 12" />
      <Label x={120} y={108} t="12개 선 모두 아래" />
      <TriUp x={206} y={26} />
    </>
  ),
  gmma_below: (
    <>
      <L d="M20 34 Q90 46 150 68 T216 96" c={MUTED} w={1} />
      <L d="M20 39 Q90 51 150 73 T216 101" c={MUTED} w={1} />
      <L d="M20 44 Q90 56 150 78 T216 106" c={MUTED} w={1} />
      <L d="M20 49 Q90 61 150 83 T216 111" c={MUTED} w={1} />
      <L d="M24 48 L60 62 L96 72 L132 90 L172 104 L212 118" />
      <Label x={120} y={26} t="12개 선 모두 위" />
      <TriDown x={206} y={104} c={DOWN} />
    </>
  ),
  // ── 이격도 ────────────────────────────
  disp20_high: (
    <>
      <L d="M20 76 L216 76" c={MUTED} w={1.5} dash="4 4" />
      <Label x={22} y={92} t="20일 이동평균" />
      <L d="M24 78 L64 72 L104 62 L144 44 L184 32 L212 24" />
      <L d="M198 76 L198 28" c={MUTED} w={1} dash="3 3" />
      <Label x={126} y={110} t="15% 이상 위 = 115" />
      <TriDown x={212} y={48} c={DOWN} />
    </>
  ),
  disp20_low: (
    <>
      <L d="M20 54 L216 54" c={MUTED} w={1.5} dash="4 4" />
      <Label x={22} y={42} t="20일 이동평균" />
      <L d="M24 52 L64 58 L104 68 L144 86 L184 98 L212 106" />
      <L d="M198 54 L198 102" c={MUTED} w={1} dash="3 3" />
      <Label x={126} y={28} t="15% 이상 아래 = 85" />
      <TriUp x={212} y={70} />
    </>
  ),
  disp60_high: (
    <>
      <L d="M20 80 Q120 74 216 70" c={MUTED} w={1.5} dash="4 4" />
      <Label x={22} y={96} t="60일 이동평균" />
      <L d="M24 82 L64 74 L104 60 L144 40 L184 26 L212 18" />
      <L d="M198 71 L198 22" c={MUTED} w={1} dash="3 3" />
      <Label x={126} y={112} t="30% 이상 위 = 130" />
      <TriDown x={212} y={44} c={DOWN} />
    </>
  ),
  disp60_low: (
    <>
      <L d="M20 50 Q120 56 216 60" c={MUTED} w={1.5} dash="4 4" />
      <Label x={22} y={38} t="60일 이동평균" />
      <L d="M24 48 L64 56 L104 70 L144 90 L184 104 L212 112" />
      <L d="M198 59 L198 108" c={MUTED} w={1} dash="3 3" />
      <Label x={126} y={24} t="25% 이상 아래 = 75" />
      <TriUp x={212} y={78} />
    </>
  ),
  // ── 상승 패턴 ──────────────────────────
