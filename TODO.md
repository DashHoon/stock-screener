...
- [ ] BACKFILL_YEARS=10, 전 종목 재백필 + 캐시 용량 실측
- [ ] 주봉/월봉 리샘플 모듈 + 타임프레임별 지표·다이버전스 재계산
- [ ] chart JSON v2 (일2년/주10년/월10년) + 용량 실측 (~150MB 목표, 초과 시 대안 검토)
- [ ] 프론트 일/주/월 탭 + 기간 버튼 연동
- [ ] CI 재백필·배포 검증 (배치·웹 동시 배포)
