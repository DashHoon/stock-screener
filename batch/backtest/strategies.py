...
STRATEGIES: list[dict] = [
    ...
    },
    {
        ...
        "confirm": None,
        "desc": "가격 저점이 계속 낮아지는데 RSI 저점은 계속 높아지는 상태가 세 저점 이상 이어진 뒤 진입. 한 번만 어긋난 경우(div-bull)와 직접 비교했을 때 5·20·60·120일 수익률에 통계적으로 유의한 차이가 없었습니다 — 이어졌다는 사실만으로 더 낫다고 보기는 어렵습니다.",
    },
    {
        "id": "div-bear-x3",
        "name": "하락 다이버전스 연속",
        ...
        "confirm": None,
        "desc": "가격 고점이 계속 높아지는데 RSI 고점은 계속 낮아지는 상태가 세 고점 이상 이어진 뒤의 성과. 하락 신호이므로 수익률이 낮게 나오는 것이 정상입니다. 한 번만 어긋난 경우(div-bear)와 유의한 차이는 없었습니다.",
    },
    {
